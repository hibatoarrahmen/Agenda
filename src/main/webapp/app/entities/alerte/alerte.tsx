    ...
    <div>
      ...
      <div className="table-responsive">
        {alerteList && alerteList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('delais')}>
                  Delais <FontAwesomeIcon icon={getSortIconByFieldName('delais')} />
                </th>
                <th />
              </tr>
            </thead>
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button
                        onClick={() => (window.location.href = `/alerte/${alerte.id}/delete`)}
                        color="danger"
                        size="sm"
          ...
          !loading && <div className="alert alert-warning">Aucun Alerte trouvé</div>
        )}
      </div>
    </div>
  );
