...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITEDEPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVITEDEPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVITEDEPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVITEDEPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITEDEPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVITEDEPT actions', async () => {
      const arg = 42666;
