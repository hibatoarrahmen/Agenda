...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGENDADEPT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AGENDADEPT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AGENDADEPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_AGENDADEPT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_AGENDADEPT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AGENDADEPT actions', async () => {
      const arg = 42666;
