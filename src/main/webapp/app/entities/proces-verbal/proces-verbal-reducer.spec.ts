...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PROCESVERBAL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PROCESVERBAL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PROCESVERBAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_PROCESVERBAL actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_PROCESVERBAL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PROCESVERBAL actions', async () => {
      const arg = 42666;
