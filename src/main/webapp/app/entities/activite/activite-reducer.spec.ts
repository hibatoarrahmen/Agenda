...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './activite.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ACTIVITE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ACTIVITE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ACTIVITE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ACTIVITE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ACTIVITE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ACTIVITE actions', async () => {
      const arg = 42666;
